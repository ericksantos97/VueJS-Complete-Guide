<template>
  <div id="app">
    ...
    <hr />
    <p
      v-destaque-local:fundo.atrasar="{cor1: 'green', atraso: 5000}"
    >Usando diretiva personalizada local</p>
    <p
      v-destaque-local.atrasar.alternar="{cor1: 'green', cor2: 'red', atraso: 2000, intervalo: 200}"
    >Usando diretiva personalizada local</p>
  </div>
</template>
